        ...
        <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
          <div className="px-4 py-6 sm:px-0">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-3xl font-bold text-gray-900">Drawing Management</h2>
            ...
            {loading ? (
              ...
              <div className="bg-white rounded-lg shadow overflow-hidden">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {drawings.map((drawing) => (
                      <tr key={drawing._id}>
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{drawing.drawingNumber}</td>
                        <td className="px-6 py-4 text-sm text-gray-500">{drawing.title}</td>
                        <td className="px-6 py-4 text-sm text-gray-500">{drawing.product?.name || 'N/A'}</td>
                        <td className="px-6 py-4 text-sm text-gray-500">{drawing.order?.orderNumber || '-'}</td>
                        <td className="px-6 py-4 text-sm text-gray-500">{drawing.version}</td>
                        <td className="px-6 py-4 text-sm text-gray-500">{drawing.fileType}</td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                          <Link href={`/admin/drawing/${drawing._id}`} className="text-brand-blue hover:underline">View</Link>
                          <Link href={`/admin/drawing/${drawing._id}/edit`} className="text-brand-yellow hover:underline">Edit</Link>
                          <button
                ...
                {drawings.length === 0 && (
                  <div className="text-center py-12 text-gray-500">No drawings found</div>
                )}
              </div>
            )}
          </div>
