...
export default function Button({
  ...
  const variants = {
    primary: 'bg-brand-blue text-white hover:bg-blue-600 focus:ring-brand-blue shadow-md hover:shadow-lg',
    secondary: 'bg-brand-green text-white hover:bg-green-600 focus:ring-brand-green shadow-md hover:shadow-lg',
